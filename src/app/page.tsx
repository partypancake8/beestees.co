  ...
  return (
    <>
      ...
      >
        <div className="container-site section-pad">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            {/* Left */}
            <AnimateIn anim="fade-right" className="flex flex-col gap-6 max-w-lg">
            ...
            {/* Right — hero image */}
            <AnimateIn anim="fade-left" delay={200} className="relative">
              <div
                className="img-placeholder rounded-2xl w-full float-gentle"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-wrap gap-2">
                {["Premium cotton", "Relaxed fit", "Mission-backed"].map(
                  (t) => (
                    <span
                      key={t}
        ...
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <AnimateIn anim="fade-right">
              ...
              >
                Every purchase contributes to pollinator-positive work.
                Here&apos;s what the hive has made possible so far.
              </p>
            </AnimateIn>
            ...
            <div className="grid grid-cols-2 gap-4">
              {STATS.map((s, i) => (
                <AnimateIn key={s.label} anim="scale-in" delay={i * 100 as 0 | 100 | 200 | 300}>
                <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col gap-5 order-1 md:order-2">
              ...
              <p
                ...
                style={{ color: "var(--gray-mid)" }}
              >
                We started Bee&apos;s Tees because we wanted something that
                looked good and meant something. Turns out a lot of people feel
                the same way. Premium fabrics, thoughtful design, and a piece of
                every sale going toward the pollinators that keep things alive.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p
                ...
                style={{ color: "var(--gray-mid)" }}
              >
                Bee&apos;s Tees is an apparel brand built on a simple idea:
                clothing should look great and do something useful. We design
                pieces people actually wear — and put a real portion of every
                sale toward supporting the pollinators that the natural world
                depends on.
              </p>
              <p
                className="text-sm leading-relaxed"
        ...
        <div className="container-site section-pad">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {TESTIMONIALS.slice(0, 3).map((t, i) => (
              <AnimateIn key={t.name} anim="fade-up" delay={i * 100 as 0 | 100 | 200}>
                <TestimonialCard {...t} />
              </AnimateIn>
            ))}
          </div>
      ...
      <section style={{ backgroundColor: "var(--panel-dark)" }} id="newsletter">
        <div className="container-site section-pad">
          <AnimateIn anim="scale-in" className="max-w-xl mx-auto text-center flex flex-col items-center gap-5">
            <span className="eyebrow" style={{ color: "var(--honey)" }}>
              Stay in the loop
            </span>
